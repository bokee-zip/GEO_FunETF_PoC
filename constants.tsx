...
export const SLIDES: SlideData[] = [
  ...
  {
    id: 3,
    title: "이중글쓰기 : UX를 해치지 않는 병렬 정보 구조화",
    subtitle: "사람을 위한 경험과 AI를 위한 정보를 동시에 설계하는 듀얼 트랙 전략",
    type: 'dual-writing',
    content: "하나의 페이지를 AI가 인용하기 좋은 글과 사람이 구매하기 좋은 글로 병렬 설계합니다. UX 디자인과 브랜드 메세지는 보존하되, AI가 파싱하기 쉬운 데이터 레이어를 구축합니다.",
    items: [
      { label: "60자 이내 정의 문장 배치" },
      { label: "핵심 성능 지표의 데이터 구조화" },
      { label: "공신력 있는 테스트 근거 명시" },
      { label: "비교 가능한 표(Table) 구조화" },
      { label: "제품 관련 스펙 FAQ 섹션 고도화" }
    ]
  },
